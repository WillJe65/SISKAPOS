...
const jadwalsRoutes = require('./BACKEND/routes/jadwals.js');
const riwayatsRoutes = require('./BACKEND/routes/riwayats.js');
const masyarakatsRoutes = require('./BACKEND/routes/masyarakats.js');
...
app.use('/api/jadwals', jadwalsRoutes);
app.use('/api/riwayats', riwayatsRoutes);
app.use('/api/masyarakats', masyarakatsRoutes);
